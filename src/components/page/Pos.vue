...
export default {
  ...
  created() {
    axios
      .get(
        "https://www.easy-mock.com/mock/5f8bcc51b260f247acdf2c10/ReactDemo01/oftengoods"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://www.easy-mock.com/mock/5f8bcc51b260f247acdf2c10/ReactDemo01/type0Goods"
      )
      .then((response) => {
        //console.log(response);
